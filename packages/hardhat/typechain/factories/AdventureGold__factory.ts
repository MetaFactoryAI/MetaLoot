...
import type { AdventureGold, AdventureGoldInterface } from "../AdventureGold";
...
export class AdventureGold__factory {
  static readonly abi = _abi;
  static createInterface(): AdventureGoldInterface {
    return new utils.Interface(_abi) as AdventureGoldInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AdventureGold {
    return new Contract(address, _abi, signerOrProvider) as AdventureGold;
  }
}
