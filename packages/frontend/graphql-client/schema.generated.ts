...
export const generatedSchema = {
  ...
  mutation: {
    ...
    checkoutCreate: {
      ...
      __args: { input: 'CheckoutCreateInput!', queueToken: 'String' },
    },
  ...
  Checkout: {
    ...
    buyerIdentity: { __type: 'CheckoutBuyerIdentity!' },
  ...
  CheckoutBuyerIdentityInput: { countryCode: { __type: 'CountryCode!' } },
  ...
  CheckoutCreateInput: {
    ...
    buyerIdentity: { __type: 'CheckoutBuyerIdentityInput' },
  },
  CheckoutCreatePayload: {
    __typename: { __type: 'String!' },
    checkout: { __type: 'Checkout' },
    checkoutUserErrors: { __type: '[CheckoutUserError!]!' },
    queueToken: { __type: 'String' },
    userErrors: { __type: '[UserError!]!' },
  },
...
export interface CheckoutBuyerIdentity {
  __typename: 'CheckoutBuyerIdentity' | undefined;
  /**
...
export interface CheckoutCreatePayload {
   ...
   * The checkout queue token. Available only to selected stores.
   */
  queueToken?: Maybe<ScalarsEnums['String']>;
  /**
   * The list of errors that occurred from executing the mutation.
   * @deprecated Use `checkoutUserErrors` instead
   */
 ...
 */
export interface Customer extends Omit<HasMetafields, '__typename'> {
...
export interface Localization {
  __typename: 'Localization' | undefined;
  /**
 ...
 */
export interface Location extends Omit<Node, '__typename'> {
...
export interface LocationAddress {
  __typename: 'LocationAddress' | undefined;
  /**
...
export interface LocationConnection {
  __typename: 'LocationConnection' | undefined;
  /**
   * A list of edges.
   */
...
export interface LocationEdge {
  __typename: 'LocationEdge' | undefined;
  /**
   * A cursor for use in pagination.
   */
  cursor: ScalarsEnums['String'];
...
export interface SellingPlan {
  __typename: 'SellingPlan' | undefined;
  /**
...
export interface SellingPlanAllocation {
  __typename: 'SellingPlanAllocation' | undefined;
  /**
...
export interface SellingPlanAllocationConnection {
  __typename: 'SellingPlanAllocationConnection' | undefined;
  /**
   * A list of edges.
   */
...
export interface SellingPlanAllocationEdge {
  __typename: 'SellingPlanAllocationEdge' | undefined;
  /**
   * A cursor for use in pagination.
   */
  cursor: ScalarsEnums['String'];
...
export interface SellingPlanAllocationPriceAdjustment {
  __typename: 'SellingPlanAllocationPriceAdjustment' | undefined;
  /**
...
export interface SellingPlanConnection {
  __typename: 'SellingPlanConnection' | undefined;
  /**
   * A list of edges.
   */
...
export interface SellingPlanEdge {
  __typename: 'SellingPlanEdge' | undefined;
  /**
   * A cursor for use in pagination.
   */
  cursor: ScalarsEnums['String'];
...
export interface SellingPlanFixedAmountPriceAdjustment {
  __typename: 'SellingPlanFixedAmountPriceAdjustment' | undefined;
  /**
...
export interface SellingPlanFixedPriceAdjustment {
  __typename: 'SellingPlanFixedPriceAdjustment' | undefined;
  /**
...
export interface SellingPlanGroup {
  __typename: 'SellingPlanGroup' | undefined;
  /**
...
export interface SellingPlanGroupConnection {
  __typename: 'SellingPlanGroupConnection' | undefined;
  /**
   * A list of edges.
   */
...
export interface SellingPlanGroupEdge {
  __typename: 'SellingPlanGroupEdge' | undefined;
  /**
   * A cursor for use in pagination.
   */
  cursor: ScalarsEnums['String'];
...
export interface SellingPlanGroupOption {
  __typename: 'SellingPlanGroupOption' | undefined;
  /**
...
export interface SellingPlanOption {
  __typename: 'SellingPlanOption' | undefined;
  /**
...
export interface SellingPlanPercentagePriceAdjustment {
  __typename: 'SellingPlanPercentagePriceAdjustment' | undefined;
  /**
...
export interface SellingPlanPriceAdjustment {
  __typename: 'SellingPlanPriceAdjustment' | undefined;
  /**
 ...
 */
export interface Shop extends Omit<HasMetafields, '__typename'> {
...
export interface StoreAvailability {
  __typename: 'StoreAvailability' | undefined;
  /**
...
export interface StoreAvailabilityConnection {
  __typename: 'StoreAvailabilityConnection' | undefined;
  /**
   * A list of edges.
   */
...
export interface StoreAvailabilityEdge {
  __typename: 'StoreAvailabilityEdge' | undefined;
  /**
   * A cursor for use in pagination.
   */
  cursor: ScalarsEnums['String'];
...
export type MetafieldParentResource =
  | {
      ...
      currentSubtotalPrice?: undefined;
      currentTotalDuties?: undefined;
      currentTotalPrice?: undefined;
      currentTotalTax?: undefined;
      ...
      images?: undefined;
      lastIncompleteCheckout?: undefined;
      lastName?: undefined;
      lineItems?: undefined;
      media?: undefined;
      /**
      ...
      sellingPlanAllocations?: undefined;
      ...
      shippingDiscountAllocations?: undefined;
      shippingPolicy?: undefined;
      shipsToCountries?: undefined;
      shopifyPaymentsAccountId?: undefined;
      sku?: undefined;
      statusUrl?: undefined;
      storeAvailability?: undefined;
      subtotalPrice?: undefined;
      subtotalPriceV2?: undefined;
      successfulFulfillments?: undefined;
      /**
       * A categorization that a article can be tagged with.
       */
      tags: Array<ScalarsEnums['String']>;
      ...
      totalPriceV2?: undefined;
      totalRefunded?: undefined;
      totalRefundedV2?: undefined;
      totalShippingPrice?: undefined;
      totalShippingPriceV2?: undefined;
      totalTax?: undefined;
      totalTaxV2?: undefined;
      unitPrice?: undefined;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  LocationSortKeys: LocationSortKeys | undefined;
  ...
  ProductMediaSortKeys: ProductMediaSortKeys | undefined;
